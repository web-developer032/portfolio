    ...
    >
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <article className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4 ">
          <div className="text-left text-4xl font-bold  bg-${borderColor}-700 p-4 px-8 text-white skew-x-12">
          ...
          <div className="bg-white p-4 px-8 text-gray-900 text-left skew-x-12">
            <p className="-skew-x-2">
              ...
              <b className={`border-b-4 border-${borderColor}-700`}>Websites</b> &{" "}
              <b className={`border-b-4 border-${borderColor}-700`}>Web Applications</b> with{" "}
              <b className={`border-b-4 border-${borderColor}-700`}>4 years</b> of experience
              according to clients requirements. Which are ranging from{" "}
              <b className={`border-b-4 border-${borderColor}-700`}>
